...
#endif
    ParticlesDrawCPU::SortingKeys[0].ClearAndFree();
    ParticlesDrawCPU::SortingKeys[1].ClearAndFree();
    ParticlesDrawCPU::SortingIndices.ClearAndFree();
    ParticlesDrawCPU::SortedIndices.ClearAndFree();
